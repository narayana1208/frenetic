...
(* OASIS_START *)
(* DO NOT EDIT (digest: fc5504a99f6b1d868bbab377047f1447) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "install the Frenetic executable";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build things that rely on lwt";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["NetKAT_Stream"];
                      lib_pack = false;
                      lib_internal_modules = ["Controller"];
                      lib_findlib_parent = Some "netcore";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "netkat_test.ml"});
               Executable
                 ({
                     cs_name = "distfrenetic";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "DistributedCompiler.ml"
                   });
               Executable
                 ({
                     cs_name = "disttest";
                   ...
                   {exec_custom = false; exec_main_is = "ParTest.ml"})
            ];
          plugins =
            [
               (`Extra, "META", Some "0.3");
     ...
     oasis_version = "0.4.1";
     oasis_digest =
       Some "\175\176\127\225\181\218\022\184L\026\173\178\149\0178\157";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
